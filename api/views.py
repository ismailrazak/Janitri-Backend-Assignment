...
from api.serializers import PatientSerializer, HeartRateSerializer, RegistrationSerializer
...
class HeartDataView(APIView):
    ...
    def post(self,request,pk=None):
        ...
        if not hasattr(request.user,"patient_profile"):
            return Response({"error":"Please create a patient profile before entering heart data."},status=status.HTTP_400_BAD_REQUEST)
